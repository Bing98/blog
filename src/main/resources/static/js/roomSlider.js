;(function(){
    ...
    RoomSlider.prototype.resetCss = function(){
        ...
        createStyle.innerHTML+='.image-nav{padding:0 4px;list-style:none;position:absolute;font-size:0px;background:rgba(222,222,222,0.4);bottom:10px;right:10px;text-align:center;-moz-border-radius:10px;border-radius:10px;}';	//nav样式
    ...
    RoomSlider.prototype.resetAllButton = function(){
        ...
        nav.id = 'nav';
        nav.setAttribute('class','image-nav');
