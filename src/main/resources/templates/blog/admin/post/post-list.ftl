...
<div class="x-body">
    <div>
        <button class="layui-btn layui-btn-danger" id="updateStatus" status="2"><i class="layui-icon"></i>移入草稿箱</button>
        <button class="layui-btn"><i class="layui-icon"></i><a href="/admin/post/writer">添加文章</a></button>
    ...
    layui.use('laypage', function(){
        ...
        laypage.render({
            ...
            jump: function(obj, first){
                ...
                //首次不执行
                if(!first){
                    window.location.href = "/admin/post?page=" + page + "&size=" + size;
                }
            }
        });
    });
